import{s as t}from"./fe0NePqv.js";import{i as e,t as i}from"./ieXrR95O.js";import{a as o,n as r,o as a}from"./De2cniRw.js";import{a as n,c as s,i as l,n as c,o as d,r as u,s as p,t as h}from"./COnucD7_.js";import{A as w,D as g,O as b,P as f,S as v,T as m,a as y,b as x,c as $,d as k,g as C,h as R,k as j,n as O,r as I,v as S,w as T,x as z,y as P}from"./gCAPN93G.js";import{n as W,t as E}from"./BLtGhX9y.js";import{t as L}from"./KMbmetZC.js";var D=e`
  :host {
    position: relative;
...
`,pt=function(t,e,i,o){var r,a=arguments.length,n=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(n=(a<3?r(n):a>3?r(e,i,n):r(e,i))||n);return a>3&&n&&Object.defineProperty(e,i,n),n},ht=class extends i{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=S.state.connectors,this.recommended=z.state.recommended,this.featured=z.state.featured,this.unsubscribe.push(S.subscribeKey("connectors",t=>this.connectors=t),z.subscribeKey("recommended",t=>this.recommended=t),z.subscribeKey("featured",t=>this.featured=t))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return a`
    ...
    `}connectorListTemplate(){const{custom:t,recent:e,announced:i,injected:o,multiChain:r,recommended:n,featured:s,external:c}=E.getConnectorsByType(this.connectors,this.recommended,this.featured);return E.getConnectorTypeOrder({custom:t,recent:e,announced:i,injected:o,multiChain:r,recommended:n,featured:s,external:c}).map(t=>{switch(t){case"injected":return a`
          ...
          ></w3m-connect-external-widget>`;case"recommended":return a`<w3m-connect-recommended-widget
            .wallets=${n}
            tabIdx=${l(this.tabIdx)}
          ></w3m-connect-recommended-widget>`;default:return console.warn(`Unknown connector type: ${t}`),null}})}};ht.styles=ut,pt([s()],ht.prototype,"tabIdx",void 0),pt([p()],ht.prototype,"connectors",void 0),pt([p()],ht.prototype,"recommended",void 0),pt([p()],ht.prototype,"featured",void 0),ht=pt([n("w3m-connector-list")],ht);var wt=e`
  :host {
    display: inline-flex;
    background-color: var(--wui-color-gray-glass-002);
