...
`,M=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s},G=class extends t{constructor(){super(...arguments),this.size="md",this.disabled=!1,this.icon="copy",this.iconColor="inherit"}render(){const e="lg"===this.size?"--wui-border-radius-xs":"--wui-border-radius-xxs",t="lg"===this.size?"--wui-spacing-1xs":"--wui-spacing-2xs";return this.style.cssText=`\n    --local-border-radius: var(${e});\n    --local-padding: var(${t});\n`,i`
    ...
    `}};G.styles=[f,N,R,_],M([a()],G.prototype,"size",void 0),M([a({type:Boolean})],G.prototype,"disabled",void 0),M([a()],G.prototype,"icon",void 0),M([a()],G.prototype,"iconColor",void 0),G=M([o("wui-icon-link")],G);var q=e`
  button {
    display: block;
    display: flex;
    align-items: center;
